...
def genericSearch(problem: SearchProblem, frontier: util.Stack) -> List[Directions]:
    ...
    while not frontier.isEmpty():
        ...
        for successor, action, stepCost in problem.getSuccessors(currentState):
            ...
            if successor not in visited or new_g < visited[successor]:
                ...
                frontier.push((successor, path + [action], new_g), new_g + heuristic(successor, problem))
    return [] # No solution found
